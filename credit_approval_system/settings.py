...
SECRET_KEY = 'django-insecure-08d7@10#mj$^8nrog#z1l+=&-cz1v^e_=0a1r92wvd+@7u#ra_'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DJANGO_DB_NAME') or "db",
        'HOST': os.getenv('DJANGO_DB_HOST') or "localhost",
        'PORT': os.getenv('DJANGO_DB_PORT') or "5432",
        'USER': os.getenv('DJANGO_DB_USER') or "postgres",
        'PASSWORD': os.getenv('DJANGO_DB_PASSWORD') or "postgres123",
    }
}
